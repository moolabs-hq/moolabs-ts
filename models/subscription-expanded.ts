...
export interface SubscriptionExpanded {
    ...
    /**
     * Idempotency key linking this subscription to the accepted quote version that created it.
     * @type {string}
     * @memberof SubscriptionExpanded
     */
    'quoteOriginKey'?: string;
    /**
     * Transient grant activation status returned by create and quote-origin duplicate recovery flows.
     * @type {string}
     * @memberof SubscriptionExpanded
     */
    'grantsStatus'?: string;
