...
// @ts-ignore
import type { QuoteTemplateResponse } from './quote-template-response';

/**
 * 
 * @export
 * @interface QuoteTemplateListResponse
 */
export interface QuoteTemplateListResponse {
    /**
     * 
     * @type {Array<QuoteTemplateResponse>}
     * @memberof QuoteTemplateListResponse
     */
    'items': Array<QuoteTemplateResponse>;
}
