...
// @ts-ignore
import type { PooloverridesValue } from './pooloverrides-value';

/**
 * 
 * @export
 * @interface CreditOverridePayload
 */
export interface CreditOverridePayload {
    /**
     * 
     * @type {{ [key: string]: PooloverridesValue; }}
     * @memberof CreditOverridePayload
     */
    'poolOverrides': { [key: string]: PooloverridesValue; };
}
