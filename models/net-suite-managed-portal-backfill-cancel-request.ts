 ...
 * 
 * @export
 * @interface NetSuiteManagedPortalBackfillCancelRequest
 */
export interface NetSuiteManagedPortalBackfillCancelRequest {
    /**
     * 
     * @type {string}
     * @memberof NetSuiteManagedPortalBackfillCancelRequest
     */
    'reason'?: string;
}
