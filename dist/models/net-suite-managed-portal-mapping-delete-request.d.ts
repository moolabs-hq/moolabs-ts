 ...
 *
 * @export
 * @interface NetSuiteManagedPortalMappingDeleteRequest
 */
export interface NetSuiteManagedPortalMappingDeleteRequest {
    /**
     *
     * @type {string}
     * @memberof NetSuiteManagedPortalMappingDeleteRequest
     */
