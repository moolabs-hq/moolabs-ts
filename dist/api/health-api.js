...
const HealthApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        readinessCheck: (...args_1) => __awaiter(this, [...args_1], void 0, function* (options = {}) {
    ...
    return {
        ...
        readinessCheck(options) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c;
                const localVarAxiosArgs = yield localVarAxiosParamCreator.readinessCheck(options);
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['HealthApi.readinessCheck']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
...
class HealthApi extends base_1.BaseAPI {
     ...
     */
    readinessCheck(options) {
        return (0, exports.HealthApiFp)(this.configuration).readinessCheck(options).then((request) => request(this.axios, this.basePath));
    }
}
