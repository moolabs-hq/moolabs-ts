    ...
    return {
        ...
        resendWebhook(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['WebhooksApi.resendWebhook']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
...
class WebhooksApi extends base_1.BaseAPI {
     ...
     */
    resendWebhook(options) {
        return (0, exports.WebhooksApiFp)(this.configuration).resendWebhook(options).then((request) => request(this.axios, this.basePath));
    }
}
