...
exports.EventsNamespace = exports.CostNamespace = exports.UsageNamespace = exports.Namespace = void 0;
exports.isTerminalIngestError = isTerminalIngestError;
...
function isTerminalIngestError(err) {
...
class Namespace {
    constructor(capability, getClient, importApiClass) {
        ...
        if (!(capability in _dx_routing_1.CAPABILITY_MAP)) {
            throw new Error(`unknown capability ${capability}; valid: ${Object.keys(_dx_routing_1.CAPABILITY_MAP).sort().join(', ')}`);
        }
        this.capability = capability;
        for (const bc of _dx_routing_1.CAPABILITY_MAP[capability]) {
...
class UsageNamespace extends Namespace {
    constructor(opts) {
...
exports.UsageNamespace = UsageNamespace;
 ...
 */
class CostNamespace extends Namespace {
    constructor(opts) {
...
exports.CostNamespace = CostNamespace;
...
exports.EventsNamespace = EventsNamespace;
function makeNamespace(capability, opts) {
    var _a, _b;
    if (capability === 'usage') {
