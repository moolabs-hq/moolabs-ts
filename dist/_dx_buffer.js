...
exports.IngestBuffer = exports.DEFAULT_INGEST_BUFFER_CONFIG = exports.IngestBufferFull = exports.OVERFLOW_RAISE = exports.OVERFLOW_DROP_OLDEST = void 0;
exports.OVERFLOW_DROP_OLDEST = 'drop_oldest';
exports.OVERFLOW_RAISE = 'raise';
class IngestBufferFull extends Error {
    constructor(message) {
        super(message);
        this.name = 'IngestBufferFull';
    }
}
exports.IngestBufferFull = IngestBufferFull;
...
exports.DEFAULT_INGEST_BUFFER_CONFIG = {
    maxSize: 1000,
    flushIntervalSec: 20.0,
    shutdownFlushTimeoutSec: 60.0,
    overflow: exports.OVERFLOW_DROP_OLDEST,
};
class IngestBuffer {
    constructor(opts) {
        var _a, _b;
        ...
        this.inFlight = false;
        this.stopped = false;
        const config = Object.assign(Object.assign({}, exports.DEFAULT_INGEST_BUFFER_CONFIG), ((_a = opts.config) !== null && _a !== void 0 ? _a : {}));
        if (config.maxSize <= 0)
        ...
        if (config.overflow !== exports.OVERFLOW_DROP_OLDEST && config.overflow !== exports.OVERFLOW_RAISE) {
    ...
    enqueue(events) {
        ...
        if (overflow > 0) {
            if (this.config.overflow === exports.OVERFLOW_RAISE) {
