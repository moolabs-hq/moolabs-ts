...
exports.Moolabs = void 0;
exports.pascalToKebab = pascalToKebab;
const _dx_buffer_1 = require("./_dx_buffer");
const _dx_namespaces_1 = require("./_dx_namespaces");
...
class Moolabs {
    ...
    toString() {
        return `Moolabs(baseUrl=${JSON.stringify(this.baseUrl)}, buffer=${this.bufferEnabled}, capabilities=${_dx_routing_1.CAPABILITY_ORDER.length})`;
    }
    // ── Internals ────────────────────────────────────────────────────────
    ns(capability) {
        ...
        const n = (0, _dx_namespaces_1.makeNamespace)(capability, opts);
    ...
    lazyBuffer() {
        ...
        if (this.ingestBuffer === null) {
            ...
            this.ingestBuffer = new _dx_buffer_1.IngestBuffer({
    ...
    bufferDrainCallback(events) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const inflight = (0, _dx_post_1.postEventsBatchAndClassify)(url, this.apiKey, events).then((outcome) => {
                switch (outcome.type) {
                    case 'success':
