 ...
 */
import type { TemplateVersionResponse } from './template-version-response';
/**
 *
 * @export
...
export interface TemplateVersionListResponse {
    /**
     *
     * @type {Array<TemplateVersionResponse>}
     * @memberof TemplateVersionListResponse
     */
    'items': Array<TemplateVersionResponse>;
}
