 ...
 *
 * @export
 * @interface PendingProviderConfirmationReconcileRequest
 */
export interface PendingProviderConfirmationReconcileRequest {
    /**
     *
     * @type {number}
     * @memberof PendingProviderConfirmationReconcileRequest
     */
    'max_records'?: number;
}
