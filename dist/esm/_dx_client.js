...
export class ClsNamespace {
    ...
    get wallets() { return new WalletsApi(this.cfg); }
    get grants() { return new GrantsApi(this.cfg); }
    get ledger() { return new LedgerApi(this.cfg); }
    get alerts() { return new AlertsApi(this.cfg); }
    get autoTopup() { return new AutoTopupApi(this.cfg); }
    ...
    get rateCards() { return new RateCardsApi(this.cfg); }
    get rating() { return new RatingApi(this.cfg); }
    get fxRates() { return new FxRatesApi(this.cfg); }
    get portal() { return new ClsPortalApi(this.cfg); }
    get subscriptions() { return new ClsSubscriptionsApi(this.cfg); }
}
...
export class MeterNamespace {
    ...
    get events() { return new EventsApi(this.cfg); }
    get meters() { return new MetersApi(this.cfg); }
    get customers() { return new CustomersApi(this.cfg); }
    get subscriptions() { return new MeterSubscriptionsApi(this.cfg); }
    get billing() { return new MeterBillingApi(this.cfg); }
    get entitlements() { return new EntitlementsApi(this.cfg); }
    get notifications() { return new NotificationsApi(this.cfg); }
    get apps() { return new AppsApi(this.cfg); }
    get portal() { return new MeterPortalApi(this.cfg); }
    get productCatalog() { return new ProductCatalogApi(this.cfg); }
    get subjects() { return new SubjectsApi(this.cfg); }
}
