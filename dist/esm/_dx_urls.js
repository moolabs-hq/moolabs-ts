...
import { DEFAULT_REGION, REGION_INGEST_MAP, SUBDOMAIN_MAP, } from './_dx_routing';
 ...
 */
export function stripPath(hostOrUrl) {
    try {
 ...
 */
export function extractEnvPrefix(apiKey) {
 ...
 */
export function resolveEffectiveBaseUrl(baseUrl, apiKey) {
    var _a;
...
export function deriveHost(backend, baseUrl) {
 ...
 */
export function hostMatchesBaseUrl(rawUrl, baseUrl) {
    let host;
    try {
...
export const DEFAULT_INGEST_RESOLVER_CONFIG = {
...
export class IngestUrlResolver {
    constructor(opts) {
        ...
        this.region = (_b = opts.region) !== null && _b !== void 0 ? _b : DEFAULT_REGION;
        this.config = Object.assign(Object.assign({}, DEFAULT_INGEST_RESOLVER_CONFIG), ((_c = opts.config) !== null && _c !== void 0 ? _c : {}));
